...
export default function Button({ children, loading, className = '', ...props }: ButtonProps) {
  return (
    <button
      ...
      className={`
        /* py-[1.125rem] (18px padding) vervangt de vaste h-[54px] */
        py-[1.125rem] px-8 
        rounded-full cursor-pointer transition-all duration-300 ease-in-out 
        flex items-center justify-center uppercase font-poppins font-semibold 
        text-btn bg-dark text-text-primary border border-primary         
